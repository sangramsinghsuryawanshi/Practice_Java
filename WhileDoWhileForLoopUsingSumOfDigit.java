...
public class WhileDoWhileForLoopUsingSumOfDigit
{
	public static void main(String[]ar)
	{
		...
		System.out.println("sum of digit number using while loop : "+sum);
		System.out.println("**********************************************");
		...
		System.out.println("sum of digit number using do while loop : "+sum1);
		System.out.println("**********************************************");
		...
		System.out.println("sum of digit number using for loop : "+sum2);
		System.out.println("**********************************************");
	}
}
